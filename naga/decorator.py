...
def naga(
    ...
    Args:
        snapshot_params (dict, optional): Parameters for the @snapshot decorator. 
            Example: {'branch': 'my-branch', 'message': 'custom msg'}. Defaults to None.
    ...
    def decorator(fn):
        ...
        def wrapper(*args, **kwargs):
            # This wrapper is mainly for functools.wraps to work correctly.
            # The actual logic is in the decoration chain below.
        ...
        # The wrapper is not strictly needed here as the decorators should preserve the signature,
        # but we return the final decorated function.
        return decorated_fn
